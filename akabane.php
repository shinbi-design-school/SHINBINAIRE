...
<head>
    ...
    <title>クイズSHNBINAIRE - 赤羽根先生</title>
    <!-- ファビコン -->
...
<body class="quiz-body">
  <!-- 先生画像 -->
  <img src="images/akabane_bust.png" alt="" class="center-graphic">
  ...
  <div id="resultModal" class="result-modal" style="display:none;">
    <div class="result-modal-inner">
      ...
      <div class="result-buttons">
        ...
        <a href="ranking.html?teacher=akabane" class="result-btn">ランキングを表示</a>
      </div>
    </div>
  </div>
  ...
  <script src="js/akabane.js"></script>
</body>
</html>